...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='A script to map fastq reads to a set of genes of interest, e.g. MLST alleles.',
            usage='usage: p3-read-mapping.py --pe read1.fq:read2.fq --se reads.fq --kma_index name')
    ...
    parser.add_argument('--kma_index', required=False, help='indexed allele sequences for kma')
